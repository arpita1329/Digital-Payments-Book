...
export default function ContactPostCard() {
  const handleClick = () => {
    window.alert("Mail of your problem has been shared with you. Your problem has been shared with the retailer as well. You will get a response asap. Thank you for contacting");
  };
  ...
  return (
    <>
      ...
      <Stack direction="row" alignItems="center"  sx={{ my: 2 }}>
        <Checkbox />Want an email for the same
      </Stack>
